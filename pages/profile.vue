...
import DetailProfile from '@/views/profile/DetailProfile.vue';
...
<template>
  <div>
    <div class="mb-4">
      <h2>Profil</h2>
      <span>Menampilkan data diri warga.</span>
    </div>
    <DetailProfile />

    <VRow>
      <VCol>
        <VBtn block color="white" class="text-primary">Ganti Password?</VBtn>
        <VBtn block color="error" class="mt-2">Keluar Akun</VBtn>
      </VCol>
    </VRow>
  </div>
</template>
